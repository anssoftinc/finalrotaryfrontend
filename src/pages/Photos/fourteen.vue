              ...
              <div class="row">
                ...
                >
                  <a
                    ...
                    data-toggle="modal"
                    data-title
                    :data-image="'/images/photos/2014-15/'+image.url"
                    :data-target="`#${image.type}`"
                    style="object-fit:cover;"
                  >
                    <img
                      class="img-thumbnail"
                      v-lazy="'/images/photos/2014-15/'+image.url"
                      alt="Retratos"
                    />
                  </a>
                </div>
  ...
  async mounted() {
    ...
    for (let i = 8; i <= 225; i++) {
      if (vm.getlength(i) == 1) {
        ...
        this.arr.push({ url: "2014-15-" + i + ".jpg", type: "image-gallery" });
      }
    }
    this.$nextTick(() => {
      Vue.addScript(
