              ...
              <div class="row">
                ...
                >
                  <a
                    ...
                    data-toggle="modal"
                    data-title
                    :data-image="'/images/photos/2015-16/'+image.url"
                    :data-target="`#${image.type}`"
                    style="object-fit:cover;"
                  >
                    <img
                      class="img-thumbnail"
                      v-lazy="'/images/photos/2015-16/'+image.url"
                      alt="Retratos"
                    />
                  </a>
                </div>
  ...
  async mounted() {
    ...
    for (let i = 1; i <= 4; i++) {
      if (vm.getlength(i) == 1) {
        ...
        this.arr.push({ url: "2015-16-" + i + ".jpg", type: "image-gallery" });
      }
    }
    this.$nextTick(() => {
      Vue.addScript(
